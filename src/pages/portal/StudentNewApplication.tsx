    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-zinc-400 mt-2">Select your desired university and program to begin the application process.</p>
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full bg-zinc-950 border border-zinc-800 rounded-lg p-3 text-zinc-100 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
            >
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full bg-zinc-950 border border-zinc-800 rounded-lg p-3 text-zinc-100 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 disabled:opacity-50"
            >
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-zinc-300 flex items-center gap-2">
              <MapPin className="w-4 h-4 text-emerald-400" /> Campus
            </label>
            <select
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-zinc-300 flex items-center gap-2">
              <BookOpen className="w-4 h-4 text-emerald-400" /> Program
            </label>
            <select
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-zinc-300 flex items-center gap-2">
              <Calendar className="w-4 h-4 text-emerald-400" /> Intake
            </label>
            <select
          ...
          <div className="pt-4 border-t border-zinc-800">
            <button
              ...
              className="w-full bg-emerald-500 hover:bg-emerald-600 text-zinc-950 font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
